<div class="mb-3 card" style="background:#111d2c">
	...
	<div class="card-body">
        <canvas id="model" width="400" height="200"></canvas>
	</div>
</div>
...
<script>
        $(document).ready(function() {
            ...
            function createChart(data) {
                ...
                const label = data.map(item => item.diffusion_mode);

                var ctx = document.getElementById('model').getContext('2d');
